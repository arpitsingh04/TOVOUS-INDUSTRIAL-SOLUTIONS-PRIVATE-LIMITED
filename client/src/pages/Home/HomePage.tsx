    ...
    <div className="home-page">
      ...
      <section className="hero-section">
        ...
        <div className="hero-content">
          <div className="hero-text">
            <p className="hero-subtitle">Established 1994</p>
            <h1 className="hero-title">
              Your Trusted Partner in Global Recruitment Solutions
            </h1>
            <p className="hero-description">
              Nearly three decades of excellence in connecting exceptional talent 
              with outstanding opportunities across domestic staffing, skilled 
              professionals, and comprehensive business services.
            </p>
      ...
      <section className="section welcome-section">
        <div className="container">
          <h2 className="section-title">About Intralink</h2>
          <div className="welcome-content">
            <div className="welcome-text">
              <p>
                Established on 19th September 1994, Intralink is a multi-service agency with nearly 30 years of 
                excellence in Manpower Recruitment, Cleaning & Hospitality Services, Digital Marketing Solutions, 
                and Trading, Construction, and Transport Services.
              </p>
              <p>
                We are committed to professionalism, client satisfaction, and global talent solutions. 
                Explore our legacy of reliability and trusted service.
              </p>
            ...
            <div className="welcome-image-container">
              <img 
                ...
                alt="Professional team at Intralink" 
